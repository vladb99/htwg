...
public class JDBC_Demo {
    public static void main(String args[]) {
        ...
        try {
            ...
            String myUpdateQuery = "INSERT INTO adresse(nr, plz, strasse, stadt, lname) " +
                    "VALUES(11, '11111', 'Testo de test', 'Testy', 'Deutschland')";				// Mitarbeiter hinzufügen
            stmt.executeUpdate(myUpdateQuery);

            String mySelectQuery = "SELECT * FROM adresse";
            rset = stmt.executeQuery(mySelectQuery);									// Query ausführen

            while(rset.next())
                System.out.println(rset.getInt("anr") + " "
                        + rset.getInt("nr") + " "
                        + rset.getString("plz") + " "
            ...
            myUpdateQuery = "DELETE FROM adresse WHERE anr = 9";
